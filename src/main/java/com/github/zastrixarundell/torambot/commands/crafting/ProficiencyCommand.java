...
public class ProficiencyCommand extends DiscordCommand
{
    ...
    private void sendMessage(int level, ArrayList<Integer> types, MessageCreateEvent messageCreateEvent)
    {
        ...
        types.forEach(type ->
        {
            ...
            {
                title = "Item: Revita I";
                description = "Proficiency: 0 - 10";
            }

            if (type == 1)
            {
                title = "Item: Revita II";
                description = "Proficiency: 10 - 30";
            }

            if (type == 2)
            {
                title = "Item: Revita III";
                description = "Proficiency: 30 - 55/60";
            }

            if (type == 3)
            {
                title = "Item: Regera III";
                description = "Proficiency: 30 - 65/70";
            }

            if (type == 4)
            {
                title = "Item: Revita IV";
                description = "Proficiency: 55 - 70";
            }

            if (type == 5)
            {
                title = "Item: Vaccine III";
                description = "Proficiency: 65 - 100";
            }
            if (type == 6)
            {
                title = "Item: Revita V";
                description = "Proficiency: 70 - 100/105";
            }

            if (type == 7)
            {
                title = "Item: Loincloth";
                description = "Proficiency: 105 - 120";
            }

            if (type == 8)
            {
                title = "Item: Revita VI";
                description = "Proficiency: 120 - 132";
            }

            if (type == 9)
            {
                title = "Item: Orichalcum";
                description = "Proficiency: 132 - 150";
            }

            if (type == 10)
            {
                title = "Item: High Purity Orichalcum";
                description = "Proficiency: 150 - 200";
            }
