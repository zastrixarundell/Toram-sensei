...
public class Help implements MessageCreateListener
{
    ...
    public void onMessageCreate(MessageCreateEvent messageCreateEvent)
    {
        ...
        EmbedBuilder embed = new EmbedBuilder()
                ...
                .addField(Values.getPrefix() + "item [Item Name]", "You can use this command to search " +
                ...
                .addField(Values.getPrefix() + "maintenance", "This command is used to show the latest maintenance data.")
