...
public class XtalCommand implements MessageCreateListener
{
    ...
    public void onMessageCreate(MessageCreateEvent messageCreateEvent)
    {
        ...
        if (!messageCreateEvent.getMessageContent().toLowerCase().startsWith(Values.getPrefix() + "xtal"))
            if (!messageCreateEvent.getMessageContent().toLowerCase().startsWith(Values.getPrefix() + "crysta"))
                if (!messageCreateEvent.getMessageContent().toLowerCase().startsWith(Values.getPrefix() + "crystal"))
                    return;
