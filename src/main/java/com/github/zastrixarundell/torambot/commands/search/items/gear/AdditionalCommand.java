...
public class AdditionalCommand implements MessageCreateListener
{
    ...
    public void onMessageCreate(MessageCreateEvent messageCreateEvent)
    {
        ...
        if (!messageCreateEvent.getMessageContent().toLowerCase().startsWith(Values.getPrefix() + "additional"))
            if (!messageCreateEvent.getMessageContent().toLowerCase().startsWith(Values.getPrefix() + "add"))
                return;
