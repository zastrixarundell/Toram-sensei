...
public class BowGunCommand implements MessageCreateListener
{
    ...
    public void onMessageCreate(MessageCreateEvent messageCreateEvent)
    {
        ...
        if (!messageCreateEvent.getMessageContent().toLowerCase().startsWith(Values.getPrefix() + "bowgun"))
            if (!messageCreateEvent.getMessageContent().toLowerCase().startsWith(Values.getPrefix() + "gun"))
                return;
