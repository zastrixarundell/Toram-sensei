...
public class TwoHandedSwordCommand implements MessageCreateListener
{
    ...
    public void onMessageCreate(MessageCreateEvent messageCreateEvent)
    {
        ...
        if (!messageCreateEvent.getMessageContent().toLowerCase().startsWith(Values.getPrefix() + "twohanded"))
            if (!messageCreateEvent.getMessageContent().toLowerCase().startsWith(Values.getPrefix() + "2h"))
                return;
